...
// Cosine similarity between two equal-length vectors (the speaker-verification
// parity metric: the C++ embedding must match the reference at cosine >= 0.9999).
...
// Read a string KV entry from a baseline gguf.
